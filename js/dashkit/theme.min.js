...
!(function () {
  ...
  (function () {
    ...
    'undefined' != typeof Chart &&
      (void 0 === demoMode || (demoMode && 'dark' == t)) &&
      a();
  })(),
  (function () {
  ...
  (function () {
    ...
    [].forEach.call(e, function (t) {
      ...
      $(e).on('hide.bs.dropdown', function () {
        var e;
        (e = this.querySelector('.dropdown-menu').querySelectorAll(
          '.dropdown-menu'
        )) &&
          [].forEach.call(e, function (e) {
      ...
      [].forEach.call(e, function (e) {
        ...
        (a = (t = e).dataset.options ? JSON.parse(t.dataset.options) : {}),
          (o = {
            ...
            dropdownAutoWidth: !0,
            dropdownCssClass:
              t.classList.contains('custom-select-sm') ||
              t.classList.contains('form-control-sm')
